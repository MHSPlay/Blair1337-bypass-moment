//#pragma once
//#include <Windows.h>
//#include "C:\Users\1\Documents\master peg\components\linker\lazy.h"
//#include "../linker/xorstr.hpp"
//#include <memory>
//
//enum requests
//{
...
//	{
//		auto win32u = LI_FN(LoadLibraryA).forwarded_safe_cached()((_("win32u.dll")));
//
//		void* address = (void*)LI_FN(GetProcAddress).forwarded_safe_cached()(win32u, (_("NtUserInjectMouseInput")));
//
//		if (!address)
//			return false;
//
